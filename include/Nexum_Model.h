...
void Nexum_ModelSequential_append_AvgPool1D (u64 pool_size);
void Nexum_ModelSequential_append_AvgPool2D (u64 pool_size);

void Nexum_ModelSequential_train            (void);
void Nexum_ModelSequential_evaluate         (void);
